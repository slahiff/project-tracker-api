...
RSpec.describe ResponsibilitiesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new responsibility" do

        post :create, params: {responsibility: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(responsibility_url(Responsibility.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new responsibility" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the responsibility" do
        responsibility = Responsibility.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the responsibility" do
        responsibility = Responsibility.create! valid_attributes
